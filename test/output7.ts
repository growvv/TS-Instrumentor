...
let ret = (() => {
    console.log("[PREF] begin call anonymous_062bcf64");
    ...
    const result_1 = ((a: number, b: number): number => {
        console.log("[LOG] Entering function 3bb4291d");
        let add2 = (a: number, b: number): number => {
            console.log("[LOG] Entering function 9a13f442");
            let add3 = (a: number, b: number): number => {
                console.log("[LOG] Entering function ef356bf9");
                {
                    console.log("[LOG] Exiting function ef356bf9");
                    return a + b;
                }
            };
            {
                console.log("[LOG] Exiting function 9a13f442");
                return (() => {
                    console.log("[PREF] begin call add3");
                    ...
                    console.log("[PREF] end call add3");
                    return result_2;
                })();
            }
        };
        {
            console.log("[LOG] Exiting function 3bb4291d");
            return 1 + (() => {
                console.log("[PREF] begin call add2");
                ...
                console.log("[PREF] end call add2");
                return result_3;
    ...
    console.log("[PREF] end call anonymous_062bcf64");
    return result_1;
})();
console.log(ret);
