...
for (let i = 0; i < 10; i++) {
    if (!__performanceData.loops["for_1543b657"]) {
        __performanceData.loops["for_1543b657"] = { iterationCount: 0, totalTime: 0, maxTime: 0, minTime: Infinity };
    }
    __performanceData.loops["for_1543b657"].iterationCount += 1;
    {
        console.log((() => {
